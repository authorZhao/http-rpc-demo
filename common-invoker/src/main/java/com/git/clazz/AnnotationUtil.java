...
/**
 * 注解工具类
 * 说实话这个类的功能有点loub，暂时不用了，直接使用spring的注解
 */
public class AnnotationUtil {
    ...
    public static <T extends Annotation> T getAnnotation(Class clasz, Class<T> clazz) {
        if (clasz == null) {
            return null;
        }
        return (T)clasz.getAnnotation(clazz);
    }
     ...
     * @return
     */
    public static <T extends Annotation> T getAnnotationImpl(Class clasz, Class<T> clazz) {
        return (T)getAnnotation(clasz.getInterfaces()[0],clazz);
